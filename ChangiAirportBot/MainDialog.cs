 ...
 * Description: Main dialog that uses LUIS.AI through the LuisDialog class included in the Bot Framework .NET API.
 * Setup notes: Please fill in the LUIS ID and subscription key inside the LuisModel property.
 */
...
namespace ChangiAirportBot
{
    ...
    public class MainDialog:LuisDialog<object>
    {
        ...
        /*
         * Example: Default when no intent detected
         */
        [LuisIntent("None")]
        public async Task None(IDialogContext context, LuisResult result)
        {
            await context.PostAsync("Hi! I can't understand your question at the moment, but you can see a list of FAQs here. http://www.changiairport.com/en/faq.html");
            context.Wait(MessageReceived);
        }

        /*
         * Example: "Can I leave my baggage somewhere?"
         */
        ...
        /*
         * Example: "What time is my flight AB1234?" or "What time is my flight?"
         */
        [LuisIntent("FlightInformation")]
        public async Task FlightInformation(IDialogContext context, LuisResult result)
        {
            if (result.Entities.Count > 0 && result.Entities[0].Entity != null)
            {
                ...
                {
                    await context.PostAsync("Specified flight number was not found.");
                    context.Wait(MessageReceived);
                    results = "AllFlightInfo";
                }
            ...
            {
                await context.PostAsync("No flight number was specified.");
                context.Wait(MessageReceived);
                results = "AllFlightInfo";
            }
        }
        ...
        /*
         * Example: "What items are restricted?" or "Can I bring a gun?"
         */
        ...
        {
            await context.PostAsync(
                "For items lost at the Public or Transit area:"
        ...
        {
            await context.PostAsync("You can visit our transit hotel which is located on the 3rd level of the Departure transit areas in Terminals 1, 2 and 3. Our transit hotels are located at:"
